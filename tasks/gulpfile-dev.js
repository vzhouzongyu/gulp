module.exports = function(gulp, plugins) {
    ...
    gulp.task('dev_main_js', function() {
        return gulp.src(['src/js/lib/*.js', 'src/js/module/*.js'])
...
<% }) %>
    ...
    gulp.task('default', ['dev_main_js', 'dev_conn', 'dev_sass'], function(){
